...
SECRET_KEY = 'django-insecure-uqu+n1k!)2@&p*q4t0^qv!n_888$ojp1k$-xp#c%-omm-2zk2g'
...
INSTALLED_APPS = [
    ...
    'django.contrib.auth', #user register/login
    'django.contrib.contenttypes',
    'django.contrib.sessions',
    'django.contrib.messages',
    'django.contrib.staticfiles', #static: css, js, images
    #My apps
    'products',
    'pages',
    'accounts',
...
STATICFILES_DIRS = [ #estos son los directorios donde django va a buscar los static files
